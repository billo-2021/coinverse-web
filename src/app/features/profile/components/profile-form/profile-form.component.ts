...
import {UserProfilePersonalInformationUpdate, UserProfileResponse} from "../../../../common/domain-models/profile";
...
export class ProfileFormComponent {
  ...
  public onSaveChanges(): void {
    ...
    this.profileService.updatePersonalInformation(personalInformationUpdateRequest)
      .pipe(tap(() => {
