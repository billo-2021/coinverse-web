...
import { UserAccessCredentialsStore } from '../user-access-credentials/user-access-credentials.store';
...
export class UserPrincipalStore extends BehaviorSubject<UserPrincipal | null> {
  ...
  constructor(
    ...
    private readonly _userAccessCredentialsStore$: UserAccessCredentialsStore
  ) {
