...
export class UserAccountService {
  ...
  public changePassword(changePasswordRequest: ChangePasswordRequest): Observable<HttpMessageResponse> {
    const url = this.getFullPath(this.CHANGE_PASSWORD_PATH);

    return this.httpService.patch<ChangePasswordRequest, HttpMessageResponse>(url, changePasswordRequest);
  }
